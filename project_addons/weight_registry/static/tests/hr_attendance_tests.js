odoo.define('weight_registry.tests', function (require) {
"use strict";

var testUtils = require('web.test_utils');
var core = require('web.core');

var MyAttendances = require('weight_registry.my_attendances');
var KioskMode = require('weight_registry.kiosk_mode');
var GreetingMessage = require('weight_registry.greeting_message');
...
QUnit.module('HR Attendance', {
        ...
        this.data = {
            'vehicle': {
                ...
                },
                {
                    id: 2,
                    name: "Employee B",
                    weight_registry_state: 'checked_out',
                    user_id: 2,
                    barcode: 2,
                }],
            },
    ...
    QUnit.test('simple rendering', function (assert) {
        ...
        assert.strictEqual(clientAction.$('.o_weight_registry_kiosk_mode h1').text(), 'Welcome Employee A',
    ...
    QUnit.test('Attendance Kiosk Mode Test', function (assert) {
        ...
        testUtils.addMockEnvironment(clientAction, {
            ...
            mockRPC: function(route, args) {
                if (args.method === 'weight_registry_scan' && args.model === 'vehicle') {

                    rpcCount++;
                    return $.when(self.data['vehicle'].records[0]);
                }
    ...
    QUnit.test('Attendance Greeting Message Test', function (assert) {
        ...
        function createGreetingMessage (target, barcode){
            var action = {
                ...
                next_action: "weight_registry.weight_registry_action_kiosk_mode",
                barcode: barcode,
            }
